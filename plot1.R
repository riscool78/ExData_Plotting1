#R Script file to create plot 1
library(lubridate)
...
#Combine date and time column into a date/time object (positlx)
...
#create png for plot 1
png(file="plot1.png",width=400,height=400,res=72)
